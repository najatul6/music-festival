...
const Register = () => {
    const { createUser, googleSignIn, githubSignIn, facebookSignIn } = useContext(AuthContext);
    ...
    return (
        <div
            ...
            <div
                ...
                <form onSubmit={handleRegister} className="mt-8 mb-2 md:w-80 max-w-screen-lg md:w-96">
                    <div className="mb-4 flex flex-col gap-6">
                        <div
                            ...
                            <input
                                ...
                                name="name"
                                required
                                className="peer h-full w-full rounded-md border border-blue-gray-200 bg-transparent px-3 py-3 font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 border-t-transparent focus:border-[#7c60ff] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                placeholder=" "
                        ...
                        <div
                            ...
                            <input
                                ...
                                name="email"
                                required
                                className="peer border-t-transparent h-full w-full rounded-md border border-blue-gray-200 bg-transparent px-3 py-3 font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-[#7c60ff] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                                placeholder=" "
                    ...
                    <p className="text-lg font-medium text-pink-700">{error}</p>
                    <div
                        data-aos="fade-right" data-aos-delay="50" data-aos-duration="1000"
