...
const ServiceCard = ({ service }) => {
    const { id, title, image, description, Price_Range } = service;
    ...
    return (
        <div className="max-w-sm bg-dark border border-gray-200 rounded-lg shadow dark:bg-dark dark:border-gray-700"
            data-aos="flip-left"
